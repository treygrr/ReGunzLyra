...
template<> SHOOTERCORERUNTIME_API UScriptStruct* StaticStruct<FLyraControlPointStatusMessage>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FLyraControlPointStatusMessage_Statics::NewProp_ControlPoint = { "ControlPoint", nullptr, (EPropertyFlags)0x0014000000000004, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FLyraControlPointStatusMessage, ControlPoint), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FLyraControlPointStatusMessage_Statics::NewProp_ControlPoint_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLyraControlPointStatusMessage_Statics::NewProp_ControlPoint_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FLyraControlPointStatusMessage_Statics::NewProp_OwnerTeamID = { "OwnerTeamID", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FLyraControlPointStatusMessage, OwnerTeamID), METADATA_PARAMS(Z_Construct_UScriptStruct_FLyraControlPointStatusMessage_Statics::NewProp_OwnerTeamID_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLyraControlPointStatusMessage_Statics::NewProp_OwnerTeamID_MetaData)) };
	...
	struct Z_CompiledInDeferFile_FID_LyraStarterGame_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_Messages_ControlPointStatusMessage_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_LyraStarterGame_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_Messages_ControlPointStatusMessage_h_Statics::ScriptStructInfo[] = {
		{ FLyraControlPointStatusMessage::StaticStruct, Z_Construct_UScriptStruct_FLyraControlPointStatusMessage_Statics::NewStructOps, TEXT("LyraControlPointStatusMessage"), &Z_Registration_Info_UScriptStruct_LyraControlPointStatusMessage, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraControlPointStatusMessage), 2873664380U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_LyraStarterGame_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_Messages_ControlPointStatusMessage_h_3614497010(TEXT("/Script/ShooterCoreRuntime"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_LyraStarterGame_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_Messages_ControlPointStatusMessage_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_LyraStarterGame_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_Messages_ControlPointStatusMessage_h_Statics::ScriptStructInfo),
		nullptr, 0);
