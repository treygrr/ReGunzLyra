...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UElimStreakProcessor_Statics::NewProp_ElimStreakTags_ValueProp = { "ElimStreakTags", nullptr, (EPropertyFlags)0x0000000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 1, Z_Construct_UScriptStruct_FGameplayTag, METADATA_PARAMS(nullptr, 0) }; // 1225434376
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UElimStreakProcessor_Statics::NewProp_ElimStreakTags = { "ElimStreakTags", nullptr, (EPropertyFlags)0x0020080000010001, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UElimStreakProcessor, ElimStreakTags), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UElimStreakProcessor_Statics::NewProp_ElimStreakTags_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UElimStreakProcessor_Statics::NewProp_ElimStreakTags_MetaData)) }; // 1225434376
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UElimStreakProcessor_Statics::NewProp_PlayerStreakHistory_ValueProp = { "PlayerStreakHistory", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 1, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UElimStreakProcessor_Statics::NewProp_PlayerStreakHistory = { "PlayerStreakHistory", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UElimStreakProcessor, PlayerStreakHistory), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UElimStreakProcessor_Statics::NewProp_PlayerStreakHistory_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UElimStreakProcessor_Statics::NewProp_PlayerStreakHistory_MetaData)) };
	...
	struct Z_CompiledInDeferFile_FID_LyraStarterGame_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_MessageProcessors_ElimStreakProcessor_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_LyraStarterGame_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_MessageProcessors_ElimStreakProcessor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UElimStreakProcessor, UElimStreakProcessor::StaticClass, TEXT("UElimStreakProcessor"), &Z_Registration_Info_UClass_UElimStreakProcessor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UElimStreakProcessor), 1859885387U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_LyraStarterGame_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_MessageProcessors_ElimStreakProcessor_h_774485003(TEXT("/Script/ShooterCoreRuntime"),
		Z_CompiledInDeferFile_FID_LyraStarterGame_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_MessageProcessors_ElimStreakProcessor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_LyraStarterGame_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_MessageProcessors_ElimStreakProcessor_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
